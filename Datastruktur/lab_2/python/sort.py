...
def quick_sort(array, cutoff = 100, use_median_of_three = True, shuffle_array =False):
...
def partition(array, lo, hi, use_median_of_three):
    ...
    if use_median_of_three:
        ...
        value= median_of_three(array,lo,median,hi-1)
        
        array[lo],array[value]=array[value],array[lo]
